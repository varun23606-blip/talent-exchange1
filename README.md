...
- When deployed on GitHub Pages (`https://varun23606-blip.github.io/talent-exchange1/`), requests automatically route to Render production (`https://talent-exchange-backend-p5wq.onrender.com`).
...
1. Push the contents of this repository to your GitHub repository (`varun23606-blip/talent-exchange1`).
